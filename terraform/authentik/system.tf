...
resource "authentik_brand" "home" {
  ...
  default          = false
  branding_title   = "Home"
  branding_logo    = "https://static.${module.secret_authentik.fields["cluster_domain"]}/assets/mcp_idp_logo.png"
  branding_favicon = "https://static.${module.secret_authentik.fields["cluster_domain"]}/assets/favicon.ico"
